...
class App extends Component {
  ...
  render() {
    ...
    return (
      <div className="App">
        <h1>StarDust Token Sale</h1>
        <p>Get your tokens today</p>
        <h2>KYC Whitelisting:</h2>
        Address to whitelist: <input name="kycAddress" type="text" value={this.state.kycAddress} onChange={this.handleInputChange}></input>
        <button type="button" onClick={this.handleKycWhitelisting}>whitelist</button>
        <h2>Buy Tokens:</h2>
        <p>If you want to buy tokens, send 1 wei to this address: {this.state.tokenSaleAddress}</p>
        <p>You currently have: {this.state.userTokens} DUSTS</p>
